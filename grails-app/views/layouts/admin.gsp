...
<div id="wrapper">
    ...
    <div id="container">
        <div id="menuContainer">
            <div class="menuFunc">
                <div class="menuFuncName"><p>值班管理</p></div>
                <div class="menuItemList">
                    <div class="menuItem"><span id="d1"><g:link controller="PPTItem" action="create">添加值班表</g:link></span></div>
                    <div class="menuItem"><span id="d1"><g:link controller="PPTItem" action="list">查看值班表</g:link></span></div>
                </div>
            </div>
