...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"http://localhost:8080/ppt/content/upload"             //图片上传提交地址
        ,imagePath:"/ppt/grails/content/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
